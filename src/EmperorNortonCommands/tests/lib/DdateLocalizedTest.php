...
class DdateLocalizedTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataProvider()
    {
        return array(
            ...
            array('05122015', 'Heute ist Prickel-Prickel, Siebenundvierzigster des Ausklangs im JUHD 3181.', 'Heute ist %{%A, %E %C%} im JUHD %Y.%N Wir feiern %H.', 'de'),
            array('08122015', 'Heute ist Dröhntag, Fünfzigster des Ausklangs im JUHD 3181. Wir feiern Ausfluss.', 'Heute ist %{%A, %E %C%} im JUHD %Y.%N Wir feiern %H.', 'de'),
            array('05122015', 'Heute ist Prickel-Prickel, 47. des Ausklangs im JUHD 3181.', 'Heute ist %{%A, %e %C%} im JUHD %Y.%N Wir feiern %H.', 'de'),
            array('11112015', 'Heute ist Orangewerdend, 23. des Ausklangs im JUHD 3181.', 'Heute ist %{%A, %e %C%} im JUHD %Y.%N Wir feiern %H.', 'de'),
            ...
            array('20102015', 'Heute ist Stechend, 1. des Ausklangs im JUHD 3181.', 'Heute ist %{%A, %e %C%} im JUHD %Y.%N Wir feiern %H.', 'de'),
        );
    }
